...
export const TESTIMONIALS = [
  {
    ...
    role: "Founder",
    text: "Easier than I expected, honestly. The team just got on with it, kept me posted along the way, and I never had to chase anything.",
    image: "👨‍💼",
    content: "Easier than I expected, honestly. The team just got on with it, kept me posted along the way, and I never had to chase anything.",
  },
  {
    name: "Jasmine",
    company: "Full Service Agency",
    role: "Head of Growth",
    text: "Fast, painless, and genuinely good people to deal with. They checked in when it mattered but didn't need much from us at all.",
    image: "👩‍💼",
    content: "Fast, painless, and genuinely good people to deal with. They checked in when it mattered but didn't need much from us at all.",
  },
  {
    name: "Sarah Johnson",
    company: "Tech Startup",
    role: "Founder",
    text: "Smoother than I thought it'd be. Quick communication throughout, and barely any lift required on our end. Great team.",
    image: "👩‍💼",
    content: "Smoother than I thought it'd be. Quick communication throughout, and barely any lift required on our end. Great team.",
  },
  {
    name: "Michael Chen",
    company: "SaaS Company",
    role: "Operations Manager",
    text: "Quick to set up, easy to work with, and they kept us in the loop without needing constant input from us. Just worked.",
    image: "👨‍💼",
    content: "Quick to set up, easy to work with, and they kept us in the loop without needing constant input from us. Just worked.",
  },
  {
    name: "Michael Chen",
    company: "E-commerce Business",
    role: "Operations Manager",
    text: "Genuinely easy process. The team moved fast, stayed in touch, and we didn't have to be hands-on at all. Exactly what we needed.",
    image: "👨‍💼",
    content: "Genuinely easy process. The team moved fast, stayed in touch, and we didn't have to be hands-on at all. Exactly what we needed.",
  },
];
