...
export function StickyProductsLabel() {
  return (
    <>
      {/* Desktop Version - Hangs from header with overlap */}
      <Link href="/products">
        <div className="hidden lg:block fixed right-8 top-16 z-40 cursor-pointer -mt-1">
      ...
      {/* Mobile Version - Hangs from header with overlap */}
      <Link href="/products">
        <div className="lg:hidden fixed right-4 top-14 z-40 cursor-pointer -mt-1">
