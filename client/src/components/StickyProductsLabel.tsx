    ...
    <>
      ...
      <Link href="/products">
        <div className="lg:hidden fixed right-4 top-[84px] z-40 cursor-pointer">
          <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white font-medium text-[11px] px-2 py-2 pt-3 rounded-b-md rounded-t-none hover:from-purple-700 hover:to-pink-700 transition-all duration-300 flex flex-col items-center justify-center gap-1.5 shadow-lg w-20 h-20">
            <ShoppingCart size={18} />
