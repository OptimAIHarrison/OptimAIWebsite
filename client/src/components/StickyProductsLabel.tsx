...
export function StickyProductsLabel() {
  return (
    <>
      {/* Desktop Version - Hangs from header, top overlaps header border */}
      <Link href="/products">
        <div className="hidden lg:block fixed right-8 top-[70px] z-40 cursor-pointer">
      ...
      {/* Mobile Version - Hangs from header, top overlaps header border */}
      <Link href="/products">
        <div className="lg:hidden fixed right-4 top-[58px] z-40 cursor-pointer">
