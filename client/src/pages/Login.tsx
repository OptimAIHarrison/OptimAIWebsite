  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-secondary/20 to-background flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-white/5 border-2 border-white/20 backdrop-blur-xl rounded-2xl p-8 md:p-10">
          {/* Header */}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-white/5 border-2 border-white/20 rounded-lg text-foreground placeholder-foreground/40 focus:outline-none focus:ring-2 focus:ring-accent/50 focus:border-accent transition-all"
                  required
                />
              </div>
            </div>
