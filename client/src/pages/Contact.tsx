              ...
              >
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-white/5 border-2 border-white/20 rounded-lg px-4 py-2 text-foreground placeholder-foreground/50 focus:outline-none focus:border-accent"
